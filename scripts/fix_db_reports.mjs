...
- **마지막 💡 애널리스트의 픽**에는 이 종목의 특성(IT, 뷰티, 식품 등)과 연관된 재치있는 상품 추천하는 1문장과 함께 다음 링크를 정확히 넣으십시오: "[👉 AI 추천 관련 특가 상품 확인하기 (스폰서 링크)](https://coupa.ng/cmAdDy)"
`;
...
async function main() {
    ...
    for (let i = 0; i < picks.length; i++) {
        ...
        // REMOVED: Skip if already correct logic, because we want to force rewrite everything with the new high-quality prompt.
