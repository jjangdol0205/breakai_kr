    ...
    return (
        <section className="mb-20">
            <h3 className="text-2xl font-bold text-white flex flex-wrap items-center gap-2 mb-6">
                <span className="text-xl">🌎</span> 일일 장세 브리핑 <span className="text-xs bg-red-500/20 text-red-500 border border-red-500/30 px-2 py-0.5 rounded-full font-bold ml-2 animate-pulse whitespace-nowrap">오늘 무료</span>
            </h3>
